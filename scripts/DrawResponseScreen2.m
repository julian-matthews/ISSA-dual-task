...
elseif responseType == 2
        ...
        loc_left = [Cfg.x-5*move_x; Cfg.y];
        loc_right = [Cfg.x+5*move_x; Cfg.y];
        disk_loc_left = vertcat(loc_left - .5*Cfg.pixelsPerDegree,loc_left + .5*Cfg.pixelsPerDegree);
        disk_loc_right = vertcat(loc_right - .5*Cfg.pixelsPerDegree,loc_right + .5*Cfg.pixelsPerDegree);
        

        Screen('FillArc', Cfg.windowPtr, Cfg.green, disk_loc_left, 0, 180);
        Screen('FillArc', Cfg.windowPtr, Cfg.red, disk_loc_left, 180, 180);

        Screen('FillArc', Cfg.windowPtr, Cfg.red, disk_loc_right, 0, 180);
        Screen('FillArc', Cfg.windowPtr, Cfg.green, disk_loc_right, 180, 180);
